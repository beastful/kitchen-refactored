...
import { RaycastRuler } from "../legacy/raycast-ruler";
...
export function RoomWalls() {
    ...
    return <>
        ...
        <RaycastRuler from={new THREE.Vector3(1.9, -1, 2)} to={new THREE.Vector3(1.9, -1, -2)} />
        <RaycastRuler from={new THREE.Vector3(1.9, -1, -2.1)} to={new THREE.Vector3(-2, -1, -2.1)} />
        <SnapConstraint userData={{ layer: 'modules' }} name="wall-z" useCursor useDistance position={[0, 0, snap.room.w * 0.5 + depth * 0.5]}>
            <mesh name="wall" receiveShadow castShadow>
                ...
                <meshMatcapMaterial matcap={matcapTexture} color={snap.roomColor} />
            </mesh>
        </SnapConstraint>
